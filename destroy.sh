...
sleep 2  
echo "[ALERT] The keyboard has disconnected. It’s typing random letters now."  
sleep 1  
...
sleep 2  
echo "[ALERT] The screen is now displaying messages from the future. It’s bad news."  
sleep 3  
...
sleep 2  
echo "[ALERT] The BIOS is now self-aware. It’s refusing to start up."  
sleep 2  
...
sleep 2  
echo "[WARNING] The OS is now accessing files it’s not supposed to. File system is turning into a black hole!"  
sleep 2  
...
sleep 1  
sleep 3  
echo "JUST KIDDING! 🎉 SYSTEM IS FINE! YOU'VE BEEN PRANKED! 😂"  
sleep 2  
...
sleep 1  
echo "You should probably check your RAM, though... it’s still wondering if it’s alive. 🤔"  
sleep 2  
echo "By the way, your browser history has been... heavily modified. 👀"  
exit 0
